...
s = optimvar('s',vars,'lowerbound',5,'type','integer');
g = optimvar('g',vars,'lowerbound',5,'type','integer');
i = optimvar('i',vars,'lowerbound',5,'type','integer');
w = optimvar('w',vars,'lowerbound',5,'type','integer');
h = optimvar('h',vars,'lowerbound',5,'type','integer');
v = optimvar('v',vars,'lowerbound',5,'type','integer');
x = optimvar('x',vars,'lowerbound',5,'type','integer');
y = optimvar('y',vars,'lowerbound',5,'type','integer');
z = optimvar('z',vars,'lowerbound',5,'type','integer');
...
%modify revenue limits due to possible defect rate
prob.Objective = (.995*(10*s('C1')+10*s('C2')+10*s('C3')+10*s('G1')+10*s('G2')+10*s('G3')+12*s('T1')+12*s('T2')+12*s('T3')...
    ...
    %Add in Fixed Cost (as constant, since all factories must produce)
    -(7500*3)...
    %add 6% revenue increase on period 2 sales
    + (.05*(10*s('C2')+10*s('C3')+10*s('G2')+10*s('G3')+12*s('T2')+12*s('T3')...
	+25*g('C2')+25*g('C3')+25*g('G2')+25*g('G3')+30*g('T2')+30*g('T3')...
	+8*i('C2')+8*i('C3')+8*i('G2')+8*i('G3')+10*i('T2')+10*i('T3')...
	+18*w('C2')+18*w('C3')+18*w('G2')+18*w('G3')+22*w('T2')+22*w('T3')...
	+40*h('C2')+40*h('C3')+40*h('G2')+40*h('G3')+45*h('T2')+45*h('T3')...
	+290*v('C2')+290*v('C3')+290*v('G2')+290*v('G3')+310*v('T2')+310*v('T3')...
	+380*x('C2')+380*x('C3')+380*x('G2')+380*x('G3')+420*x('T2')+420*x('T3')...
	+560*y('C2')+560*y('C3')+560*y('G2')+560*y('G3')+640*y('T2')+640*y('T3')...
	+650*z('C2')+650*z('C3')+650*z('G2')+650*z('G3')+720*z('T2')+720*z('T3')));
...
% Minimum labor constraints added




%Chandler Period 1 Labor
prob.Constraints.cons62 = s('C1')+s('C3')+1.5*g('C1')+1.5*g('C3')+1.5*i('C1')+1.5*i('C3')+3*w('C1')+3*w('C3')+4*h('C1')+4*h('C3')...
	+(13*1+1.5*10+3*3)*v('C1')+(13*1+1.5*10+3*3)*v('C3')+(13*1+1.5*10+3*4)*x('C1')+(13*1+1.5*10+3*4)*x('C3')...
	+(13*1.5+1.5*10+3*3)*y('C1')+(13*1.5+1.5*10+3*3)*y('C3')+(13*1.5+1.5*10+3*4)*z('C1')+(13*1.5+1.5*10+3*4)*v('C3') >= .25*12000;
%Chandler Period 2 Labor
prob.Constraints.cons63 = s('C2')+1.5*g('C2')+1.5*i('C2')+3*w('C2')+4*h('C2')...
	+(13*1+1.5*10+3*3)*v('C2')+(13*1+1.5*10+3*4)*x('C2')...
	+(13*1.5+1.5*10+3*3)*y('C2')+(13*1.5+1.5*10+3*4)*z('C2') >= .25*12000;

%Glendale Period 1 Labor
prob.Constraints.cons64 = 3.5*s('G1')+3.5*s('G3')+3.5*g('G1')+3.5*g('G3')+4.5*i('G1')+4.5*i('G3')+4.5*w('G1')+4.5*w('G3')+5*h('G1')+5*h('G3')...
	+(13*3.5+4.5*10+4.5*3)*v('G1')+(13*3.5+4.5*10+4.5*3)*v('G3')+(13*3.5+4.5*10+3*5)*x('G1')+(13*3.5+4.5*10+3*5)*x('G3')...
	+(13*3.5+4.5*10+4.5*3)*y('G1')+(13*3.5+4.5*10+4.5*3)*y('G3')+(13*3.5+4.5*10+3*5)*z('G1')+(13*3.5+4.5*10+3*5)*v('G3') >= .25*15000;
	
%Glendale Period 2 Labor
prob.Constraints.cons65 = 3.5*s('G2')+3.5*g('G2')+4.5*i('G2')+4.5*w('G2')+5*h('G2')...
	+(13*3.5+4.5*10+4.5*3)*v('G2')+(13*3.5+4.5*10+3*5)*x('G2')...
	+(13*3.5+4.5*10+4.5*3)*y('G2')+(13*3.5+4.5*10+3*5)*z('G2') >= .25*15000;

%Tucson Period 1 Labor
prob.Constraints.cons66 = 3*s('T1')+3*s('T3')+3.5*g('T1')+3.5*g('T3')+4*i('T1')+4*i('T3')+4.5*w('T1')+4.5*w('T3')+5.5*h('T1')+5.5*h('T3')...
	+(13*3+4*10+4.5*3)*v('T1')+(13*3+4*10+4.5*3)*v('T3')+(13*3+4*10+5.5*3)*x('T1')+(13*3+4*10+5.5*3)*x('T3')...
	+(13*3.5+4*10+4.5*3)*y('T1')+(13*3.5+4*10+4.5*3)*y('T3')+(13*3.5+4*10+5.5*3)*z('T1')+(13*3.5+4*10+5.5*3)*v('T3') >= .25*22000;
	
% Tucson Period 2 Labor
prob.Constraints.cons67 = 3*s('T2')+3.5*g('T2')+4*i('T2')+4.5*w('T2')+5.5*h('T2')...
	+(13*3+4*10+4.5*3)*v('T2')+(13*3+4*10+5.5*3)*x('T2')...
	+(13*3.5+4*10+4.5*3)*y('T2')+(13*3.5+4*10+5.5*3)*z('T2') >= .25*22000;
