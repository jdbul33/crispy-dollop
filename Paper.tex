...
\textit{x} & Production of product \textit{ij} \\
\textit{c} & Coefficient Cost of Product \textit{ij}\\
\end{tabular}
...
\end{equation}
\begin{equation}
\sum cx_{1_g,y,z} + \sum cx_{3_g,y,z} + e \leq G_{1}
\end{equation}
\begin{equation}
\sum cx_{2_g,y,z} \leq G_{2} + e
\end{equation}
